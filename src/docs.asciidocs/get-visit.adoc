...
=== Get stage por Id
Obtiene un visit específico usando su identificador único.

==== Ejemplo de petición
include::{snippets}/visit/get-visit/http-request.adoc[]

==== Ejemplo de respuesta
include::{snippets}/visit/get-visit/http-response.adoc[]

==== Ejemplo usando CURL
include::{snippets}/visit/get-visit/curl-request.adoc[]

==== Parámetros de la petición
include::{snippets}/visit/get-visit/path-parameters.adoc[]

==== Parámetros de la respuesta
include::{snippets}/visit/get-visit/response-fields.adoc[]
