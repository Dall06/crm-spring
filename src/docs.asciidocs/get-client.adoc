...
==== Ejemplo de petición
include::{snippets}/client/get-client/http-request.adoc[]

==== Ejemplo de respuesta
include::{snippets}/client/get-client/http-response.adoc[]

==== Ejemplo usando CURL
include::{snippets}/client/get-client/curl-request.adoc[]

==== Parámetros de la petición
include::{snippets}/client/get-client/path-parameters.adoc[]

==== Parámetros de la respuesta
include::{snippets}/client/get-client/response-fields.adoc[]
