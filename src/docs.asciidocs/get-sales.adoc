...
=== Get sale por Id
Obtiene un sale específico usando su identificador único.

==== Ejemplo de petición
include::{snippets}/sale/get-sale/http-request.adoc[]

==== Ejemplo de respuesta
include::{snippets}/sale/get-sale/http-response.adoc[]

==== Ejemplo usando CURL
include::{snippets}/sale/get-sale/curl-request.adoc[]

==== Parámetros de la petición
include::{snippets}/sale/get-sale/path-parameters.adoc[]

==== Parámetros de la respuesta
include::{snippets}/sale/get-sale/response-fields.adoc[]
