...
class ClientControllerTest {
    ...
    void createClient() throws Exception {
        Client clientParam = Client.builder().name("Juan").address("Rio").employeesQty(10).email("Juan@client.com").build();
        Client clientResponse = Client.builder().id(1L).name("Manuel").address("Lagos").employeesQty(10).email("Manuel@client.com").build();
